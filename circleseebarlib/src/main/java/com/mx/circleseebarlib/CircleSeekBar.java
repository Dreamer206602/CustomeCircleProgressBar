package com.mx.circleseebarlib;
...
public class CircleSeekBar extends View{
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        ...
        //显示进度的字体的颜色
        mTextColor=a.getColor(R.styleable.CircleSeekBar_wheel_text_color,getColor(R.color.def_text_color));
        a.recycle();
    }
...
//    }
    ...
    protected void onDraw(Canvas canvas) {
        //画进度
        String text=mCurProcess+"%";
        //拿到字体的宽度和高度
        float textWidth=mPointerPaint.measureText(text);
        float textHeight=(mPointerPaint.descent()+mPointerPaint.ascent())/2;
        ...
        //设置文字的大小
        mPointerPaint.setTextSize(15);
        //TODO 设置文字进度
        mPointerPaint.setTextAlign(Paint.Align.CENTER);
        mPointerPaint.setColor(Color.WHITE);
        canvas.drawText(text, mWheelCurX - textWidth / 10, mWheelCurY - textHeight / 2, mPointerPaint);
        canvas.save();
